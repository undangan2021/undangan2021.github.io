...
$(document).on('click', function(){
    ...
    console.log('Cecep Maulana™');
});

// Set the date we're counting down to
var countDownDate = new Date("Jan 09, 2021 10:00:00").getTime();
...
var x = setInterval(function() {
    ...
    if (distance < 0) {
        clearInterval(x);
        document.getElementById("time").innerHTML = "Semoga Menjadi Keluarga Sakinah, Mawadah, Warohmah. Amiin";
    }
}, 1000);
...
console.log('\n\n%c SAVE THE DATE: 09th Jan, 2021!', styles);
